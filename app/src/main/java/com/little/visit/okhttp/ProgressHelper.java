...
public class ProgressHelper {
     ...
     */
    public static OkHttpClient addProgressResponseListener(OkHttpClient client, final IOnVisitListener progressListener) {
//        //克隆
//        OkHttpClient clone = client.clone();
     ...
     * @return 包装后的进度回调请求体
     */
    public static ProgressRequestBody addProgressRequestListener(RequestBody requestBody, IOnVisitListener progressListener) {
        //包装请求体
