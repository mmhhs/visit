...
public class UploadFileRequest extends Request<String> {
     ...
     *
     */
    public UploadFileRequest(String url, String filePartName, File file,
                                  Map<String, String> params, Response.Listener<String> listener,Response.ErrorListener errorListener) {
     ...
     *
     */
    public UploadFileRequest(String url, String filePartName, List<File> files,
                                  Map<String, String> params,Response.Listener<String> listener,Response.ErrorListener errorListener) {
        super(Method.POST, url, errorListener);
        this.mFilePartName = filePartName;
        this.listener = listener;
